...
import sys
import os
sys.path.insert(0, os.getcwd().replace("Hist_Ntuple/HistMisIDSF/sample","Ntuple_Skim/"))
sys.path.insert(0, os.getcwd().replace("Hist_Ntuple/HistMisIDSF/sample","Ntuple_Skim/sample"))
