...
#----------------------------------------
inHistSubDir = "Hist_Ntuple/HistDYSF/forDYSF/%s/%s/%s/Merged"%(year, decayMode, channel)
inHistFullDir = "%s/%s"%(condorHistDir, inHistSubDir)
outPlotSubDir = "Plot_Hist/PlotDYSF/forDYSF/%s/%s/%s/%s"%(year, decayMode, channel, region)
