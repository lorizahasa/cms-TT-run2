...
parser.add_option("", "--sortBy", dest="sortBy", default="impact", type='string', help="choose 'correlation' or 'impact' to sort rows by correlation with or impact on --poi (largest to smallest absolute)")
