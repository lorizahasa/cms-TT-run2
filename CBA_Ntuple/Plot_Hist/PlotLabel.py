...
labelDict = { 
         "Muon_pt"              : "p^{#mu}_{T} (GeV)",
         "Muon_eta"             : "#eta^{#mu}",
         "Muon_phi"             : "#phi^{#mu}", 
         "Electron_pt"          : "p^{e}_{T} (GeV)",
         "Electron_eta_sc"      : "#eta^{e}_{SC}",
         "Electron_phi"         : "#phi^{e}", 
         "Photon_et"            : "E^{#gamma}_{T} (GeV)",  
         "Photon_size"          : "N^{#gamma}",
         "Jet_size"             : "N^{j}",
         "Jet_b_size"           : "N^{b}",
         "Jet_pt"               : "p^{j}_{T} (GeV)",
         "Jet_eta"              : "#eta^{j}",
         "Reco_met"             : "E^{miss}_{T} (GeV)",
         "Reco_mass_lgamma"     : "m_{l#gamma} (GeV)",
         "Reco_mass_t_had"      : "m_{t}^{had} (GeV)",
         "Reco_mass_t_lep"      : "m_{t}^{lep (GeV)}",
         "Reco_ht"              : "H_{T} (GeV)",
         "Reco_st"              : "S_{T} (GeV)",
         "Reco_mass_T_had"      : "m_{t^{#times}}^{had} (GeV)",
         "Reco_mass_T_lep"      : "m_{t^{#times}}^{lep} (GeV)",
         "Reco_mass_T"          : "m_{t^{#times}} (GeV)",
         "Reco_mass_TT"         : "m_{t^{#times}#bar{t^{#times}}} (GeV)",
         "Reco_mass_TT_diff"    : "m_{t^{#times}} - m_{#bar{t^{#times}}} (GeV)",
         "Reco_chi2"            : "#chi^{2}",
         "Reco_mass_dilep"      : "m_{l^{+}l^{-}} (GeV)",

         "Jet_qgl_leading"      : "Disc_{QGL}^{j_{1}}", 
         "Jet_qgl_subleading"   : "Disc_{QGL}^{j_{2}}",
         "Reco_mass_trans_w"    : "m^{W}_{T} (GeV)",
         ...
         "FatJet_size"             : "N^{#bf{t}}",
         "FatJet_pt"               : "p^{#bf{t}}_{T} (GeV)",
         "FatJet_eta"              : "#eta^{#bf{t}}",
         "FatJet_mass"             : "m^{#bf{t}} (GeV)",
         "FatJet_msoftdrop"        : "m^{sd} (GeV)",
