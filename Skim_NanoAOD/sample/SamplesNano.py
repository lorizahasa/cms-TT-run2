...
def getSignalSpin32(year, ch):
    ...
    runV = "%s-%s"%(Runs[year], vs[year])
    sampDict = {
    'SignalSpin32_M700':   '/TstarTstarTo%s_M-700_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M800':   '/TstarTstarTo%s_M-800_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M900':   '/TstarTstarTo%s_M-900_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1000':  '/TstarTstarTo%s_M-1000_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1100':  '/TstarTstarTo%s_M-1100_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1200':  '/TstarTstarTo%s_M-1200_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1300':  '/TstarTstarTo%s_M-1300_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1400':  '/TstarTstarTo%s_M-1400_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1500':  '/TstarTstarTo%s_M-1500_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1600':  '/TstarTstarTo%s_M-1600_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1700':  '/TstarTstarTo%s_M-1700_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1800':  '/TstarTstarTo%s_M-1800_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M1900':  '/TstarTstarTo%s_M-1900_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M2000':  '/TstarTstarTo%s_M-2000_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M2250':  '/TstarTstarTo%s_M-2250_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M2500':  '/TstarTstarTo%s_M-2500_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M2750':  '/TstarTstarTo%s_M-2750_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    'SignalSpin32_M3000':  '/TstarTstarTo%s_M-3000_TuneCP5_Spin32_13TeV-madgraph-pythia8/'%ch+runV+'/NANOAODSIM',
    }
    return sampDict
...
def getGJets(year):
    ...
    runV = "%s-%s"%(Runs[year], vs[year])
    sampDict2 = {
    'GJets_HT40To100'       : '/GJets_DR-0p4_HT-40To100_TuneCP5_13TeV-madgraphMLM-pythia8/'+runV+'/NANOAODSIM',
    }
    sampDict = {}
    sampDict.update(sampDict1)
    sampDict.update(sampDict2)
