...
mTT   = [-50.0, 291.0, 325.0, 352.0, 377.0, 402.0, 426.0, 452.0, 482.0, 517.0, 557.0, 605.0, 679.0, 828.0, 5949.0]
...
disc = [-1.0, -0.9, -0.88, -0.86, -0.82, -0.74, -0.64, -0.52, -0.4, -0.26, -0.08, 0.26, 0.98] 
...
#hist = inFile.Get("TTGamma/ttyg_Enriched_SR_Resolved/Base/Disc")
#hist = inFile.Get("TTGamma/ttyg_Enriched_SR_Resolved/Base/Reco_mass_T")
...
def getRebins(hist, uncThresh):
    ...
    uncBins.append(round(100/(content)**0.5, 2))
    print("Bin Index  = ",indexBins)
    print("Bin Center = ", reBins)
    print("Bin unc(%) = ", uncBins)
    return reBins
#getRebins(hist, 40)
