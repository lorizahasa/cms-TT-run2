...
#mTT   = [-50.,200,400,500,600,700,800,900,1000,1500,3000,3600] #updated, for the negative weights
...
mTT   = [-50.,200,400,600,700,900,1000,1200,1300,1450,1600,1700,1800,1950,2100,2200,2450,2700,2950,3200,3350,3500,3750,4000] #equal binning needs tunning, used for paper plots
#mTT   = [-50.,200,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1800,3600] #default, used previously, latest one 
...
disc = [-1.00,-0.30,0.0,0.30,1.00]# what was used for the last limit
