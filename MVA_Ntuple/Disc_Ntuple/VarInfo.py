...
def GetVarInfo(region, channel):
    ...
    varMu = {
             ...
             "Muon_phi"             : ["Muon_phi[0]"    , [20,-5.0,5.0], True],
            }
    varEle = {
             "Electron_eta_sc"      : ["Electron_eta_sc[0]" , [12,-2.88,2.88], True],
             "Electron_phi"         : ["Electron_phi[0]"   , [20,-5.0,5.0], True],
            }
    varFatJet = {
             "FatJet_pt"               : ["FatJet_pt[0]"              , [30,0,3000], True],
             "FatJet_eta"              : ["FatJet_eta[0]"             , [12,-2.88,2.88], True],
             "FatJet_phi"              : ["FatJet_phi[0]"             , [12,-2.88,2.88], True],
             "FatJet_mass"             : ["FatJet_mass[0]"            , [30,0,1200], True],
             "FatJet_msoftdrop"        : ["FatJet_msoftdrop[0]"       , [30,0,1200], True],
    ...
    varBase = {
             ...
             "Jet_phi"               : ["Jet_phi[0]"    , [12,-2.88,2.88], True],
             "Jet_qgl"               : ["Jet_qgl[0]"    , [12,-2.88,2.88], True],
             "Jet_size"             : ["Jet_size"     , [16,-0.5,15.5], True],
             ...
             "Reco_angle_leadPhoton_lepton"     : ["Reco_angle_leadPhoton_lepton", [20,0,5], True],
             "Photon_eta"       : ["Photon_eta[0]", [20,-4,4], True],
