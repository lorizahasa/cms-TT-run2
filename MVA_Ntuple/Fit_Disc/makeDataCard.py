...
cb.cp().process(allMC).AddSyst(cb, "JEC_SubTotalPileUp",    "shape",ch.SystMap("era") (["13TeV"], 1.0))
cb.cp().process(allMC).AddSyst(cb, "JEC_SubTotalRelative",    "shape",ch.SystMap("era") (["13TeV"], 1.0))
cb.cp().process(allMC).AddSyst(cb, "JEC_SubTotalAbsolute",    "shape",ch.SystMap("era") (["13TeV"], 1.0))
