...
import os
import sys
sys.path.insert(0, os.getcwd().replace("MVA_Ntuple/Fit_Disc/FitCombTrain", "CBA_Ntuple/Plot_Hist/PlotMain"))
sys.path.insert(0, os.getcwd().replace("Fit_Disc/FitCombTrain", "Disc_Ntuple/DiscCombTrain"))
import json
