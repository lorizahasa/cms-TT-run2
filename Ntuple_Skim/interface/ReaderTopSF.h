...
public:
	TopSF(){
        ...
        topSF_300To400["2016PreVFP"]  ={1.23-0.14, 1.23, 1.23+0.16}; 
        topSF_300To400["2016PostVFP"] ={1.08-0.10, 1.08, 1.08+0.11}; 
        topSF_300To400["2017"]        ={1.11-0.08, 1.11, 1.11+0.12}; 
        topSF_300To400["2018"]        ={1.19-0.12, 1.19, 1.19+0.12}; 
        //400 < pT < 480 GeV
        topSF_400To480["2016PreVFP"]  ={1.07-0.05, 1.07, 1.07+0.10}; 
        topSF_400To480["2016PostVFP"] ={0.99-0.05, 0.99, 0.99+0.06}; 
        topSF_400To480["2017"]        ={1.01-0.04, 1.01, 1.01+0.04}; 
        topSF_400To480["2018"]        ={0.98-0.04, 0.98, 0.98+0.04}; 
        //480 < pT < 600 GeV
        topSF_480To600["2016PreVFP"]  ={1.04-0.05, 1.04, 1.04+0.14}; 
        topSF_480To600["2016PostVFP"] ={1.03-0.05, 1.03, 1.03+0.07}; 
        topSF_480To600["2017"]        ={1.05-0.04, 1.05, 1.05+0.09}; 
        topSF_480To600["2018"]        ={0.96-0.03, 0.96, 0.96+0.04}; 
        //600 < pT < 1200 GeV
        topSF_600To1200["2016PreVFP"] ={1.06-0.10, 1.06, 1.06+0.18}; 
        topSF_600To1200["2016PostVFP"]={1.29-0.23, 1.29, 1.29+0.25}; 
