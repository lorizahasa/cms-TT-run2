#ifndef SELECTOR_GEN_H
#define SELECTOR_GEN_H
...
public:
	...
	double ele_Pt_cut;
        ...
        double mu_Eta_tight;
        double mu_Pt_cut;
        double mu_miniRelIso_tight;
        double mu_miniRelIso_loose;
	...
	double mu_PtLoose_cut;
        double mu_miniRelIsoLoose_cut;
        double mu_miniRelIso_range[2];
